...
class RandomMultiClient2NodeFailoverTest(TestLvolHACluster):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.test_name = "continuous_random_failover_2node_client_ha"
    ...
    def perform_failover_during_outage(self):
        ...
        self.collect_outage_diagnostics("pre_failover_during_outage")
        ...
        self.collect_outage_diagnostics(f"pre_recovery_node_{self.current_outage_node}")
