...
if __name__ == '__main__':
    ...
    if mode == "caching_docker_node":
        app.register_api(internal_api.node_api_basic.api)
        app.register_api(internal_api.caching_node.docker.api)

    if mode == "caching_kubernetes_node":
        app.register_api(internal_api.node_api_basic.api)
        app.register_api(internal_api.caching_node.kubernetes.api)
