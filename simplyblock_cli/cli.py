...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_storage_node__add_node(self, subparser):
        ...
        subcommand.add_argument('--failure-domain', help='The failure-domain label (e.g. RACK1, AZ2) identifying the rack/cabinet/DC this node belongs to. Required when the cluster was created with --enable-failure-domain; must be omitted otherwise.', type=str, dest='failure_domain')
