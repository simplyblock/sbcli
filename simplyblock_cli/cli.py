...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_storage_node__restart(self, subparser):
        ...
        argument = subcommand.add_argument('--force-lvol-recreate', help='Force LVol recreate on node restart even if lvol bdev was not recovered', dest='force_lvol_recreate', action='store_true')
