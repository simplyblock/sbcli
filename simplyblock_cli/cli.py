...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_cluster__collect_logs(self, subparser):
        ...
        argument = subcommand.add_argument('--namespace', help='Kubernetes namespace to collect CSI / storage-node DS pod logs from (default: simplyblock). Pass an empty string to skip kubectl collection.', type=str, dest='namespace')
