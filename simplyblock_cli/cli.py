...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_storage_node__add_node(self, subparser):
        ...
        argument = subcommand.add_argument('--failure-domain', help='The failure-domain tag (rack/cabinet/DC) this node belongs to. Required when the cluster was created with --enable-failure-domain; must be omitted otherwise.', type=str, dest='failure_domain')
