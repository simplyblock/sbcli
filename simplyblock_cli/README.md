...
```bash
usage: sbcli-pre storage-node [-h]
...
```bash
usage: sbcli-pre storage-node deploy [-h] [--ifname IFNAME]
...
```bash
usage: sbcli-pre storage-node deploy-cleaner [-h]
...
```bash
usage: sbcli-pre storage-node add-node [-h] [--partitions PARTITIONS]
...
```bash
usage: sbcli-pre storage-node delete [-h] node_id
...
```bash
usage: sbcli-pre storage-node remove [-h] [--force-remove] [--force-migrate]
                                     node_id
...
```bash
usage: sbcli-pre storage-node list [-h] [--cluster-id CLUSTER_ID] [--json]
...
```bash
usage: sbcli-pre storage-node get [-h] id
...
```bash
usage: sbcli-pre storage-node resume [-h] node_id
...
```bash
usage: sbcli-pre storage-node get-io-stats [-h] [--history HISTORY] node_id
...
```bash
usage: sbcli-pre storage-node get-capacity [-h] [--history HISTORY] node_id
...
```bash
usage: sbcli-pre storage-node list-devices [-h] [-s {node-seq,dev-seq,serial}]
                                           [--json]
                                           node_id
...
```bash
usage: sbcli-pre storage-node device-testing-mode [-h]
                                                  device_id
...
```bash
usage: sbcli-pre storage-node get-device [-h] device_id
...
```bash
usage: sbcli-pre storage-node get-capacity-device [-h] [--history HISTORY]
                                                  device_id
...
```bash
usage: sbcli-pre storage-node get-io-stats-device [-h] [--history HISTORY]
                                                  device_id
...
```bash
usage: sbcli-pre storage-node port-list [-h] node_id
...
```bash
usage: sbcli-pre storage-node port-io-stats [-h] [--history HISTORY] port_id
...
```bash
usage: sbcli-pre storage-node check [-h] id
...
```bash
usage: sbcli-pre storage-node check-device [-h] id
...
```bash
usage: sbcli-pre storage-node info [-h] id
...
```bash
usage: sbcli-pre storage-node info-spdk [-h] id
...
```bash
usage: sbcli-pre cluster create [-h] [--blk_size {512,4096}]
...
```bash
usage: sbcli-pre cluster add [-h] [--blk_size {512,4096}]
...
```bash
usage: sbcli-pre cluster list [-h]
...
```bash
usage: sbcli-pre cluster status [-h] cluster_id
...
```bash
usage: sbcli-pre cluster get [-h] id
...
```bash
usage: sbcli-pre cluster suspend [-h] cluster_id
...
```bash
usage: sbcli-pre cluster unsuspend [-h] cluster_id
...
```bash
usage: sbcli-pre cluster get-capacity [-h] [--json] [--history HISTORY]
                                      cluster_id
...
```bash
usage: sbcli-pre cluster get-io-stats [-h] [--records RECORDS]
                                      [--history HISTORY]
                                      cluster_id
...
```bash
usage: sbcli-pre cluster get-cli-ssh-pass [-h] cluster_id
...
```bash
usage: sbcli-pre cluster get-logs [-h] cluster_id
...
```bash
usage: sbcli-pre cluster get-secret [-h] cluster_id
...
```bash
usage: sbcli-pre cluster upd-secret [-h] cluster_id secret
...
```bash
usage: sbcli-pre cluster check [-h] id
...
```bash
usage: sbcli-pre cluster update [-h] id
...
```bash
usage: sbcli-pre cluster graceful-shutdown [-h] id
...
```bash
usage: sbcli-pre cluster graceful-startup [-h] id
...
```bash
usage: sbcli-pre cluster list-tasks [-h] cluster_id
...
```bash
usage: sbcli-pre lvol add [-h] [--snapshot] [--max-size MAX_SIZE]
...
```bash
usage: sbcli-pre lvol qos-set [-h] [--max-rw-iops MAX_RW_IOPS]
                              [--max-rw-mbytes MAX_RW_MBYTES]
                              [--max-r-mbytes MAX_R_MBYTES]
                              [--max-w-mbytes MAX_W_MBYTES]
                              id
...
```bash
usage: sbcli-pre lvol list [-h] [--cluster-id CLUSTER_ID] [--pool POOL]
                           [--json]
...
```bash
usage: sbcli-pre lvol list-mem [-h] [--json] [--csv]
...
```bash
usage: sbcli-pre lvol get [-h] [--json] id
...
```bash
usage: sbcli-pre lvol create-snapshot [-h] id name
...
```bash
usage: sbcli-pre lvol clone [-h] [--resize RESIZE] snapshot_id clone_name
...
```bash
usage: sbcli-pre lvol move [-h] [--force] id node_id
...
```bash
usage: sbcli-pre lvol get-capacity [-h] [--history HISTORY] id
...
```bash
usage: sbcli-pre lvol get-io-stats [-h] [--history HISTORY] id
...
```bash
usage: sbcli-pre lvol send-cluster-map [-h] id
...
```bash
usage: sbcli-pre lvol get-cluster-map [-h] id
...
```bash
usage: sbcli-pre lvol check [-h] id
...
```bash
usage: sbcli-pre mgmt [-h] {add,list,remove} ...
...
```bash
usage: sbcli-pre mgmt add [-h] cluster_ip cluster_id ifname
...
```bash
usage: sbcli-pre mgmt list [-h] [--json]
...
```bash
usage: sbcli-pre mgmt remove [-h] id
...
```bash
usage: sbcli-pre pool add [-h] [--pool-max POOL_MAX] [--lvol-max LVOL_MAX]
                          [--max-rw-iops MAX_RW_IOPS]
                          [--max-rw-mbytes MAX_RW_MBYTES]
                          [--max-r-mbytes MAX_R_MBYTES]
...
```bash
usage: sbcli-pre pool set [-h] [--pool-max POOL_MAX] [--lvol-max LVOL_MAX]
                          [--max-rw-iops MAX_RW_IOPS]
                          [--max-rw-mbytes MAX_RW_MBYTES]
                          [--max-r-mbytes MAX_R_MBYTES]
                          [--max-w-mbytes MAX_W_MBYTES]
...
```bash
usage: sbcli-pre pool list [-h] [--json] [--cluster-id CLUSTER_ID]
...
```bash
usage: sbcli-pre pool get [-h] [--json] id
...
```bash
usage: sbcli-pre pool enable [-h] pool_id
...
```bash
usage: sbcli-pre pool disable [-h] pool_id
...
```bash
usage: sbcli-pre pool get-secret [-h] pool_id
...
```bash
usage: sbcli-pre pool upd-secret [-h] pool_id secret
...
```bash
usage: sbcli-pre pool get-capacity [-h] pool_id
...
```bash
usage: sbcli-pre pool get-io-stats [-h] [--history HISTORY] id
...
```bash
usage: sbcli-pre snapshot [-h] {add,list,delete,clone} ...
...
```bash
usage: sbcli-pre snapshot add [-h] id name
...
```bash
usage: sbcli-pre snapshot list [-h]
...
```bash
usage: sbcli-pre snapshot delete [-h] id
...
```bash
usage: sbcli-pre snapshot clone [-h] [--resize RESIZE] id lvol_name
...
```bash
usage: sbcli-pre caching-node [-h]
...
```bash
usage: sbcli-pre caching-node deploy [-h] [--ifname IFNAME]
...
```bash
usage: sbcli-pre caching-node add-node [-h] [--cpu-mask SPDK_CPU_MASK]
                                       [--memory SPDK_MEM]
                                       [--spdk-image SPDK_IMAGE]
                                       [--namespace NAMESPACE]
                                       cluster_id node_ip ifname
...
```bash
usage: sbcli-pre caching-node list [-h]
...
```bash
usage: sbcli-pre caching-node list-lvols [-h] id
...
```bash
usage: sbcli-pre caching-node remove [-h] [--force] id
...
```bash
usage: sbcli-pre caching-node connect [-h] node_id lvol_id
...
```bash
usage: sbcli-pre caching-node disconnect [-h] node_id lvol_id
...
```bash
usage: sbcli-pre caching-node recreate [-h] node_id
