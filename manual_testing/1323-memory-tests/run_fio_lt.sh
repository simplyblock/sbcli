...
run_fio_workload() {
    ...
    sudo fio --directory=$mount_point --readwrite=randwrite --bs=256K --size=$size --name=test --numjobs=16 \
        --nrfiles=$nrfiles --time_based=1 --runtime=100000 --direct=1 --ioengine=aiolib --iodepth=1 --verify=md5 \
