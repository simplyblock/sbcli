...
def check_lvol_size(size: int, what: str = "Volume size") -> str | None:
...
def check_snapshot_limit(lvol_id: str, snapshots: Iterable, new_objects: int = 1) -> str | None:
...
def check_clone_limit(snapshot_id: str, lvols: Iterable, new_objects: int = 1) -> str | None:
