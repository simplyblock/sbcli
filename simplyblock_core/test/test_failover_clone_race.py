...
def harness(monkeypatch):
    ...
    def _fake_select(db, lvol_id, cluster_id, generation=0, pin_snapshot_id=None):
        """Stand-in for last_replicated_target_snapshot.
    ...
    monkeypatch.setattr(lvol_controller, "last_replicated_target_snapshot", _fake_select)
