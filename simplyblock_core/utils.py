...
def calculate_pool_count(alceml_count, number_of_distribs, cpu_count, poller_count):
    ...
    return 4*small_pool_count, 1.5*large_pool_count
...
def calculate_minimum_hp_memory(small_pool_count, large_pool_count, lvol_count, max_prov, cpu_count):
    ...
    memory_consumption = (4 * cpu_count + 1.0277 * pool_consumption + 15 * lvol_count) * (1024 * 1024) + (250 * 1024 * 1024) * 1.1 * convert_size(max_prov, 'TiB') + constants.EXTRA_HUGE_PAGE_MEMORY
