...
Shipped with release 19.3 (adjust ``to_release`` at release cut). DELETE
this module — and the ``resume_is_held`` guards it exports — in the next
release. Guarded call sites (grep for ``resume_is_held``):
