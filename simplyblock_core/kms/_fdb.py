...
from simplyblock_core.models.lvol import LVol
...
class LocalKMS(KMS):
    ...
    def _lvol_by_data_encryption_key_name(self, name: str) -> LVol:
        ...
        try:
            return next(
                lvol
                for lvol in self._db_controller.list_lvols(cluster_id=self._cluster_id)
    ...
    def create_data_encryption_keys(self, kek_name: str, name: str) -> None:
        ...
        lvol.crypto_key1 = generate_hex_string(32)
        lvol.crypto_key2 = generate_hex_string(32)
    ...
    def delete_data_encryption_keys(self, name: str) -> None:
        lvol = self._lvol_by_data_encryption_key_name(name)
        lvol.crypto_key1 = None
        lvol.crypto_key2 = None
